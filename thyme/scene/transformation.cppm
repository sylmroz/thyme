...
public:
    inline void translate(const glm::vec3 offset) noexcept {
        ...
        transformMatrix = glm::gtc::translate(transformMatrix, offset);
    }
    ...
    inline void rotate(const float angle, const glm::vec3 axis) noexcept {
        ...
        transformMatrix = glm::gtc::rotate(glm::mat4(1.0f), angle, axis);
    }

    inline void scale(const glm::vec3 factor) noexcept {
        transformMatrix = glm::gtc::scale(transformMatrix, factor);
    }
